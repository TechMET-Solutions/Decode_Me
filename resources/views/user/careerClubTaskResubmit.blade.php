                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="row mt-4">
                                ...
                                <div class="image-container">
                                    ...
                                    <div style="width: 100%; height: auto; position: relative;background: #FDFFA9">
                                        ...
                                        <menu>
                                            <ul>
                                                <li><a
                                                        href="{{ route('careerClubTask') }}">Submitted({{ $submitCount }})</a>
                                                </li>
                                                <li><a
                                                ...
                                                <li><a
                                                        href="{{ route('careerClubTaskResubmit') }}"class="active">Resubmit({{ $resubmitCount }})</a>
                                                </li>
                                            </ul>
                                        </menu>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                @foreach ($resubmitTask as $index => $data)
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <p class="mb-0" style="font-family:Rubik;">
                                            ...
                                            <div class="col-lg-3 col-sm-12" style="font-family:Rubik;">
                                                <p class="mb-2"><svg width="21" height="21" viewBox="0 0 21 21"
                                                    ...
                                                    &nbsp;Status:</p>
                                                <a href="{{ route('groupTask', $data->id) }}">
                                                    <button
                                                        style="background:#71BF0D;color:#DCFFB0;border-radius:20px;border:none;padding:6px;width:80%;margin-bottom:10px;">Attempt</button>
                                                </a>
                                            </div>
