    ...
    <div class="login-container">
        <div class="login-content">
            ...
            <div class="container mt-5">
                <form method="POST" action="{{ route('changePassword') }}" class="login-form">
                    @csrf
                    <input type="hidden" name="stud_id" value="{{ $userData->id }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="confirmed-password"
                            placeholder="Confirm your password" required>
                    </div>
                    <button id="signin-btn" class="btn btn-lg btn-success btn-block mt-4" type="submit"
                        style="border-radius: 30px; background:#02b07b;">Submit</button>
                </form>
            </div>
        </div>
