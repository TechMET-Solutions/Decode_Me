    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                {{-- <h1 class="app-page-title">Task Resubmit</h1> --}}
                            ...
                            <div class="col-md-12">
                                <div class="image-container">
                                    ...
                                    <div class="button-container">
                                        <a href="{{ route('tasks') }}" class="active"><button class="button">Individual
                                                Task</button></a>
                                        <a href="{{ route('careerClubTask') }}"><button class="button">Career
                                                Club
                                                Task</button></a>
                                    </div>
                                    <div style="width: 100%; height: auto; position: relative;background: #FDFFA9">
                                        ...
                                        <menu>
                                            <ul>
                                                <li><a href="{{ route('tasks') }}">Submitted({{ $submitCount }})</a></li>
                                                <li><a href="{{ route('taskPending') }}"
                                                        class="">Pending({{ $pendingCount }})</a>
                                                </li>
                                                <li><a href="{{ route('taskOverdue') }}">Overdue({{ $overdueCount }})</a>
                                                </li>
                                                <li><a href="{{ route('taskResubmit') }}"
                                                        class="active">Resubmit({{ $resubmitCount }})</a>
                                                </li>
                                            </ul>
                                        </menu>
                                    </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-6  p-2">
                                                ...
                                                <h6 class="mb-0">{{ $data->task_name }}</h6>
                                                <p><i class="fa-regular fa-clock"></i>&nbsp;&nbsp;15 min</p>
                                            </div>
                                            <div class="col-lg-3 ">
                                                <p class="mb-0"><i class="fa-solid fa-calendar"></i>&nbsp;&nbsp;Deadline:
                                                </p>
                                                <p class="mb-0"
                                                    style="color: #000;font-size:18px;font-family:Rubik;font-weight:400;">
                                                    {{ date($data->deadlineDate) }},{{ $data->deadlineTime }}
                                                </p>
                                            </div>
                                            <div class="col-lg-3 col-sm-12">
                                                <p class="mb-2"><svg width="21" height="21" viewBox="0 0 21 21"
                                                    ...
                                                    &nbsp;Action:</p>
                                                <a href="{{ route('taskStart', $data->id) }}">
                                                    <button
                                                        style="background:#71BF0D;color:#DCFFB0;border-radius:20px;border:none;padding:6px;width:80%;margin-bottom:10px;">Submit</button>
                                                </a>
                                            </div>
                                            <div class="col-lg-12" style="margin-top:-20px;">
                                                <p> <span style="font-size:18px;font-weight:500;">Task Resubmit
                                                        Reason:</span> {{ $data->reason }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="d-flex align-items-center upcoming-task-container">
                                    ...
                                    <div class="col-lg-8 col-md-6 col-sm-12">
                                        <div class="task-details">
                                            <div class="task-title">Individual Tasks</div>
                                ...
                                <div class="row">
                                    <div class="col-6 ">
                                        <div class="d-flex justify-content-around">
                                            ...
                                            <a href="{{ route('taskIndivisualComplete') }}"><i
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex justify-content-around">
                                            ...
                                            <i class="fa-solid fa-circle-arrow-right"
                                                style="color: #FDD901;width:10%;height:auto;"></i>
                                        </div>
                                        <div class="d-flex justify-content-start">
                                            <img src="{{ asset('user/assets/images/star.png') }}" alt=""
                                                width="16%">
