                    ...
                    <div class="col-lg-8 col-sm-12 mb-4">
                        <div class="d-flex align-items-center justify-content-center upcoming-task-container">
                            ...
                            <div class="task-details">
                                <div class="task-title">AI Portals</div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            @foreach ($aiPortals as $index => $data)
                                    ...
                                    <div class="d-flex justify-content-between"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="{{ $data->link }}" target="_blank">
                                                <button
                                                    style="font-family:'Rubik';width:80px;height:34px;color: #8D5D00; background: #FFED7E; border-radius: 30px;border:none;font-weight:600">Link</button>
                                            </a>
                                        </div>
                                    </div>
                                    <hr class="mt-0 mb-0">
