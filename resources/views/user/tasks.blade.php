...
@section('content')
                                ...
                                <div class="image-container">
                                    ...
                                    <div class="button-container">
                                        <a href="{{ route('tasks') }}" class="active"><button class="button">Individual
                                                Task</button></a>
                                        <a href="{{ route('careerClubTask') }}"><button class="button">Career Club
                                                Task</button></a>
                                    </div>
                                        ...
                                        <menu>
                                            <ul>
                                                <li><a href="{{ route('tasks') }}"
                                                        class="active">Submitted({{ $submitCount }})</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex justify-content-around">
                                            ...
                                            <a href="{{ route('taskIndivisualSubmitted') }}"><i
                                                    class="fa-solid fa-circle-arrow-right"
                                                    style="color: #FDD901;width:100%;height:36px;"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('scheduleIndividualTask') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <input type="hidden" name="indi_id" id="indi_id">
    ...
    <script>
        function scheduleCall(id, taskId, SchoolId) {
            document.getElementById('indi_id').value = id;
