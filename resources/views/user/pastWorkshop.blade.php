    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                {{-- <h1 class="app-page-title">Past Workshop</h1> --}}
                                    ...
                                    <div class="col-lg-2 col-sm-12">
                                        <div class="circle bg-danger-custom">
                                            <div class="text-love-ya text-center">
                                                {{ \Carbon\Carbon::parse($workshop->end_date)->format('d') }}</div>
                                            <div class="text-love-ya text-center"
                                                style="margin-top: -18px;font-size: 26px;">
                                                {{ \Carbon\Carbon::parse($workshop->end_date)->format('F') }}</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-10 col-sm-12 d-flex justify-content-between align-items-center">
                                        <div>
                                            @php
                                                $experts = $experts = json_decode($workshop->expert, true);
                                            @endphp
                                            <h6 style="font-size: 18px;">{{ $workshop->topic }}</h6>
                                            <p>Expert : <br><span style="font-size: 20px;font-weight:500;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 col-md-8 col-sm-7">
                                                    <h6 style="color: #8D5D00;">{{ $feedback->student->name }}</h6>
                                                    <p>{{ $feedback->type }} </p>
                                                    <p>{{ $feedback->desc }} </p>
                                                </div>
                                                <div class="col-lg-1 col-md-2 col-sm-2 text-center"><i
