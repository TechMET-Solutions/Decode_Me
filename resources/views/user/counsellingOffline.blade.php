...
@section('content')
                ...
                <div class="row mb-4">
                    <div class="col-lg-8 col-sm-12 mb-4">
                        <div class="text-center">
                            <p class="heading">
                                DM Session</p>
                            {{-- <div style="width:50px; border-top: 4px solid yellow;margin-top:-30px;margin-left:440px;">
                            </div> --}}
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-12 mb-4">
                                <div class="">
                                    ...
                                    <div class="button-container">
                                        <a href="{{ route('counselling') }}"><button class="button">Online</button></a>
                                        <a href="{{ route('counsellingOffline') }}" class="active"><button
                            ...
                            <div class="col-md-12 mt-4">
                                <div class="container">
                                    ...
                                    <ul>
                                        <li>Choose the date and time slot that fits your schedule and click on a ‘Book a
                                            Session’ to proceed.
                                        </li>
                                        <li>Aim to arrive at the venue at least <b> 20 minutes</b> before the scheduled
                                            start time
                                            of the expert session.</li>
                                    </ul>
                                    <hr>
                                    <div>
                                        <div class="d-flex">
                                            <svg width="27" height="27" viewBox="0 0 27 27" fill="none"
                                                ...
                                                <rect x="0.853516" y="0.574219" width="26" height="26" rx="13"
                                                    fill="#FDD901" />
                                                <g clip-path="url(#clip0_617_2708)">
                                                    <path
                                                        d="M20.3535 12.1299C20.3535 17.1854 13.8535 21.5188 13.8535 21.5188C13.8535 21.5188 7.35352 17.1854 7.35352 12.1299C7.35352 10.406 8.03833 8.75268 9.25732 7.53369C10.4763 6.3147 12.1296 5.62988 13.8535 5.62988C15.5774 5.62988 17.2307 6.3147 18.4497 7.53369C19.6687 8.75268 20.3535 10.406 20.3535 12.1299Z"
                                                        stroke="#8D5D00" stroke-width="1.4" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="M13.8542 14.2967C15.0508 14.2967 16.0208 13.3267 16.0208 12.13C16.0208 10.9334 15.0508 9.96338 13.8542 9.96338C12.6575 9.96338 11.6875 10.9334 11.6875 12.13C11.6875 13.3267 12.6575 14.2967 13.8542 14.2967Z"
                                                        stroke="#8D5D00" stroke-width="1.4" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </g>
                                                <defs>
                                                    <clipPath id="clip0_617_2708">
                                                        <rect width="17.3333" height="17.3333" fill="white"
                                                            transform="translate(5.1875 4.90771)" />
                                                    </clipPath>
                                                </defs>
                                            </svg>&nbsp;&nbsp;
                                            <h5>Choose a Venue</h5>
                                        </div>
                                        <div class="container">
                                            <div class="row">
                                                @foreach ($dmSession as $data)
                                                    <div class="col-md-6 col-sm-6 text-center mt-2">
                                                        <div class="venue"
                                                            style="width:100%;border-radius:20px;border:1px solid black;">
                                                            <p class="m-2">{{ $data->venue }}</p>
                                                        </div>
                                                    </div>
                                                @endforeach
                                                {{-- <div class="col-md-6 col-sm-6 text-center mt-2">
                                                    <div class="venue"
                                                        style="width:100%;border-radius:20px;border:1px solid black;">
                                                        <p class="m-2">DM Office Satpur MIDC,
                                                            Ashok Nagar, Nashik</p>
                                                    </div>
                                                </div> --}}
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row mt-4">
                                        <div class="text-center">
                                            <form action="{{ route('bookSession') }}" method="post" id="booksession">
                                                ...
                                                <input type="hidden" name="venue" id="venueSelect">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mt-4 ">
                                                {{--  @foreach ($previousSession as $data2)
                                                    <div class="row mt-4" style="background:#fff;">
                                                        <div class="col-lg-2 col-sm-12">
                                                            <div class="circle bg-danger-custom">
                                                                <div class="text-love-ya text-center">
                                                                    {{ \Carbon\Carbon::parse($data2->date)->format('d') }}
                                                                </div>
                                                                <div class="text-love-ya text-center"
                                                                    style="margin-top: -18px;font-size: 26px;">
                                                                    {{ \Carbon\Carbon::parse($data2->date)->format('F') }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div>
                                                                <h6 style="font-size: 18px;">Career Quest: Guiding Children
                                                                    ...
                                                                    Success</h6>
                                                                <p>Expert : &nbsp;<span
                                                                        style="font-size: 20px;font-weight:500;">Rajesh
                                                                        Rao</span>
                                                                </p>
                                                            </div>
                                                            <div>
                                                ...
                                                @foreach ($completeSession as $value)
                                                    <div class="row mt-4" style="background:#fff;">
                                                        ...
                                                        <div
                                                            class="col-lg-8 offset-lg-2 col-sm-12 d-flex justify-content-between align-items-center">
                                                            <div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mt-4 ">
                                                ...
                                                @foreach ($cancelSession as $value2)
                                                    <div class="row mt-4" style="background:#fff;">
                                                        <div class="col-lg-2 position-relative">
                                                            <div class="circle bg-danger-custom">
                                                                <div class="text-love-ya text-center">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>Expert : &nbsp;<span
                                                                        style="font-size: 20px;font-weight:500;">{{ $value2->expert_name }}</span>
                                                                </p>
                                                            </div>
                                                            {{--  <div>
                                                                @if ($value->stud_file != null)
    ...
    {{--  <script>
        ...
        var bookedSessions = @json($bookedSession);
        ...
        // Venue selection listener
        var venueElements = document.querySelectorAll(".venue");
        venueElements.forEach(function(event) {
            event.addEventListener("click", function() {
                venueElements.forEach(function(item) {
                    item.classList.remove("selected");
                });

                event.classList.add("selected");
                selectedVenue = event.querySelector("p").textContent;
                document.getElementById('venueSelect').value = selectedVenue;

                // Filter session data based on the selected venue and update the calendar slots
                displayCalendarSlots();
            });
        });

        // Function to display calendar slots
        function displayCalendarSlots() {
            calendarContainer.innerHTML = ''; // Clear existing slots

            var filteredSessionData = sessionData.filter(function(dataRecord) {
                return dataRecord.venue === selectedVenue; // Filter based on selected venue
            });

            for (var i = 0; i < filteredSessionData.length && i < 6; i++) {
                let dataRecord = filteredSessionData[i];
                var timeSlots = JSON.parse(dataRecord.time);
                ...
                card.setAttribute('data-venue', dataRecord.venue);
                ...
                card.addEventListener('click', function() {
                    ...
                    displayTimeSlots(formattedDate, this.getAttribute('data-venue'));
        ...
        function displayTimeSlots(selectedDate, selectedVenue) {
            var eventsContainer = document.getElementById('eventsContainer');
            var dataRecord = sessionData.find(function(record) {
                return new Date(record.date).toISOString().split('T')[0] === selectedDate && record.venue ===
                    selectedVenue;
            });
            ...
            if (dataRecord) {
                ...
                // Get booked times for the selected date and venue
                var bookedTimes = bookedSessions.filter(function(session) {
                    return session.date === selectedDate && session.venue === selectedVenue;
                }).map(function(session) {
                    return session.time; // Assuming 'time' contains the booked time slot
                });
                ...
                timeSlots.forEach(function(slot) {
                    ...
                    var isBooked = bookedTimes.some(function(bookedSlot) {
        ...
        function updateSelectedTimeSlots() {
            var selectedSlots = [];
            var selectedEvents = document.querySelectorAll('.event.selected');
            selectedEvents.forEach(function(event) {
                selectedSlots.push(event.textContent.trim());
            });
            document.getElementById('timeSlot').value = selectedSlots.join(',');
        }
    ...
    <script>
        ...
        var selectedVenue = null;
        var selectedVenueId = null; // Track selected venue record ID
        ...
        venueElements.forEach(function(event) {
            event.addEventListener("click", function() {
                ...
                event.classList.add("selected");
                selectedVenue = event.querySelector("p").textContent;
                selectedVenueId = event.getAttribute('data-venue-id'); // Get venue record ID
                document.getElementById('venueSelect').value = selectedVenue;
        ...
        function displayCalendarSlots() {
            ...
            var filteredSessionData = sessionData.filter(function(dataRecord) {
                return dataRecord.venue === selectedVenue && dataRecord.venue_id ==
                    selectedVenueId; // Filter based on selected venue and venue ID
            });
        ...
        function displayTimeSlots(selectedDate, selectedVenue) {
            ...
            if (dataRecord) {
                ...
                timeSlots.forEach(function(slot) {
                    ...
                    if (!isBooked && (!isToday || startDateTime >= currentTime)) {
                        var eventElement = document.createElement('div');
                        eventElement.className = 'event';
                        eventElement.style.borderRadius = '20px';
                        eventElement.style.border = '1px solid black';
