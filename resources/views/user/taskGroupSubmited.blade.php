...
@section('content')
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                {{-- <h1 class="app-page-title">taskIndivisualComplete</h1> --}}
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-12" style="background:#fff">
                                <div class="container">
                                    @foreach ($SubmittedTask as $index => $data)
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-12 text-center">
                                                ...
                                                <button type="button" class="btn" data-bs-toggle="modal"
                                                    onclick="getTaskData('{{ $studentNamesString }}','{{ $data->school_name }}','{{ $data->task_name }}','{{ $data->task_questions }}','{{ $data->taskID }}','{{ Auth::user()->id }}')"
    ...
    <script>
        ...
        function getTaskData(studName, studSchool, studTask, questions, taskId, studId) {
            ...
            let taskData = submitedTask.find(task => task.taskID == taskId && Number(task.studId) == studId);
