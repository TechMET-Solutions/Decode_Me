                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12 col-md-12">
                        <div class="card p-2" style="overflow: hidden;border-radius:24px; background:#FEFFC2">
                            ...
                            <div class="myProfile">
                                <img src="{{ asset('stud_images/' . Auth::user()->profile) }}" class="img-fluid" />
                            </div>
                            <div>
                            ...
                            <div class="row">
                                <div class="col-md-2 offset-lg-1">
                                    <div class="text-center mt-2 mb-2">
                                        <button
                                            style="background:#8D5D00; color:#FDD901;border:none; border-radius:20px;padding:6px;width:70%">Completed</button>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="text-center mt-2 mb-2">
                                        {{-- <button>Completed</button> --}}
                                        <p style="color: #8D5D00">Yet to reach</p>
                                    </div>
                                </div>
                                <div class="col-md-2">
