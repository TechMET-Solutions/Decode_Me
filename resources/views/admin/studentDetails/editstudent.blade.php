    ...
    <div class="app-wrapper" style="background: #FFFFF4;">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <form action="{{ route('admin.updatestudent') }}" method="post" style="margin-left: 10px;"
                    ...
                    <div class="card" style="box-shadow: 0 0 30px rgba(214, 215, 216, 0.6); border:none;">
                        ...
                        <div class="row" style="font-family: Rubik; font-size:18px;color:#4E4D55; padding:20px;">
                            ...
                            <div class="col-lg-2 col-sm-12">
                                ...
                                <input type="hidden" name="id" id="id" value="{{ $studentDetail->id }}">
                                <div class="mb-3">
                                    <div id="image-preview-container">
                                        <img id="image-preview" src="{{ asset('stud_images/' . $studentDetail->profile) }}"
                                    ...
                                    <div style="text-align: center;">
                                        ...
                                        <input type="hidden" name="old_img" value="{{ $studentDetail->profile }}">
                                    </div>
                            ...
                            <div class="col-lg-5 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="stud_name" placeholder="Enter Name"
                                        value="{{ $studentDetail->name }}" class="form-control" id="stud_name"
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input type="date" name="stud_dob" value="{{ $studentDetail->dob }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="stud_phone" value="{{ $studentDetail->mobile }}"
                                        placeholder="+91" class="form-control" id="stud_phone"
                                        style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="stud_email" value="{{ $studentDetail->email }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date_of_en" value="{{ $studentDetail->enrollDate }}"
                            ...
                            <div class="col-lg-5 col-sm-12" style="font-family: Rubik; font-size:18px;color:#4E4D55;">
                                <div class="mb-3">
                                    ...
                                    <select name="school_id" id="school_id" class="form-control">
                                        <option value="{{ $studentDetail->school_id }}">
                                            @foreach ($school as $op)
                                                @if ($op->id == $studentDetail->school_id)
                                                    {{ $op->school_name }}
                                                @endif
                                            @endforeach
                                        </option>
                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <img height="60" width="60"
                                                ...
                                                src="/stud_images/{{ $studentDetail->aadhaar }}" alt="">
                                        </div>
                                        <div class="col-10">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <img height="60" width="60"
                                                style=" margin-left:10px; border-radius:5px;"
                                                src="/stud_images/{{ $studentDetail->pan }}" alt="">
                                        </div>
                                        <div class="col-10">
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input type="password" name="password" class="form-control" id="password"
                                        value="{{ $studentDetail->password }}" style="font-size:14px;color:#95949E;"
                                        readonly>
                                </div> --}}
                        ...
                        <div class="row" style="font-family: Rubik; font-size:18px;color:#4E4D55; padding:20px;">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="mother_name" value="{{ $studentDetail->motherName }}"
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="mother_phone"
                                                value="{{ $studentDetail->motherPhone }}" placeholder="+91"
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="mother_occupation"
                                                value="{{ $studentDetail->motherOccupation }}" placeholder="Occupation"
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    <label for="father_name" class="form-label">Father Name<span
                                            class="text text-danger">*</span></label>
                                    <input type="text" name="father_name" value="{{ $studentDetail->fatherName }}"
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="father_phone"
                                                value="{{ $studentDetail->fatherPhone }}" placeholder="+91"
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="father_occupation"
                                                value="{{ $studentDetail->fatherOccupation }}" placeholder="Occupation"
                        ...
                        <div class="row" style="font-family: Rubik; font-size:18px;color:#4E4D55; padding:20px;">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="bank_holder_name"
                                        value="{{ $studentDetail->bank_holder_name }}" placeholder="Account Holder Name "
                                        class="form-control" id="bank_holder_name" style="font-size:14px;color:#95949E;">
                                </div>
                                <div class="mb-3">
                                    <label for="bank_name" class="form-label">Bank Name
                                    </label>
                                    <input type="text" name="bank_name" value="{{ $studentDetail->bank_name }}"
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="bank_acc_no" value="{{ $studentDetail->bank_acc_no }}"
