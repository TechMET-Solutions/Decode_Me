    ...
    <div class="app-wrapper" style="background: #FFFFF4;">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <form action="{{ route('admin.storeinternship') }}" method="post" style="margin-left: 10px;"
                    enctype="multipart/form-data">
                    @csrf
                    <p style="font-family: Rubik; font-size:38px; font-weight:500px; color:#000">Internship</p>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="company_name" placeholder="Enter Company Name"
                                        class="form-control" id="company_name" style="font-size:14px;color: #95949E;"
                                        required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="link" placeholder="Enter Company link"
                                        class="form-control" id="link" style="font-size:14px;color: #95949E;" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="field_name" placeholder="Enter Feild Name"
                                        class="form-control" id="field_name" style="font-size:14px;color:#95949E;" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="mode" placeholder="Online/Offline" class="form-control"
                                        id="mode" style="font-size:14px;color:#95949E;" required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-12" style="font-family: Rubik; font-size:18px;color:#4E4D55;">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="duration" placeholder="Internship Duration"
                                        class="form-control" id="duration" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    <label for="joining_date" class="form-label">Joining Date
                                        <span class="text text-danger">*</span>
                                    </label>
                                    <input type="date" name="joining_date" placeholder="DD/MM/YYYY" class="form-control"
                                        id="joining_date" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    <label for="time" class="form-label">Time
                                        <span class="text text-danger">*</span></label>
                                    <input type="text" name="time" placeholder="00.00 to 00.00 "class="form-control"
                                        id="time" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    <label for="start_date" class="form-label">Start Date
                                        <span class="text text-danger">*</span>
                                    </label>
                                    <input type="date" name="start_date" placeholder="DD/MM/YYYY" class="form-control"
                                        id="start_date" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    <label for="end_date" class="form-label">End Date
                                        <span class="text text-danger">*</span>
                                    </label>
                                    <input type="date" name="end_date" placeholder="DD/MM/YYYY" class="form-control"
                                        id="end_date" style="font-size:14px;color:#95949E;" required>
                                </div>
