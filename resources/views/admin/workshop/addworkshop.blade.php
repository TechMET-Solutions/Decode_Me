    ...
    <div class="app-wrapper" style="background: #FFFFF4;">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <x-session-message />
                <form action="{{ route('admin.storeworkshop') }}" method="post" style="margin-left: 10px;"
                        ...
                        <div class="row" style="font-family: Rubik; font-size:18px;color:#4E4D55; padding:20px;">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="topic" placeholder="Topic" class="form-control"
                                        id="topic" style="font-size:14px;color: #95949E;" required>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-lg-6 col-sm-12" style="font-family: Rubik; font-size:18px;color:#4E4D55;">
                                <div class="mb-3">
                                    ...
                                    <input type="time" name="start_time_start_date" placeholder="hh:mm AM/PM"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="time" name="end_time_start_date" placeholder="hh:mm AM/PM"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="time" name="start_time_end_date" placeholder="hh:mm AM/PM"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="time" name="end_time_end_date" placeholder="hh:mm AM/PM"
