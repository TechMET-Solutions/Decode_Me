    ...
    <div class="app-wrapper" style="background: #FFFFF4;">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <form action="{{ route('admin.storeschool') }}" method="post" style="margin-left: 10px;"
                    enctype="multipart/form-data">
                    @csrf
                    <p style="font-family: Rubik; font-size:38px; font-weight:500px; color:#000">Add New School</p>
                    <div class="card" style="box-shadow: 0 0 30px rgba(214, 215, 216, 0.6); border:none;">
                        <p
                            style="font-family: Rubik; font-size:26px; font-weight:500px; color:#000;
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="school_name" placeholder="Enter School Name"
                                        class="form-control" id="school_name" style="font-size:14px;color: #95949E;"
                                        required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="school_code" placeholder="Enter School Code"
                                        class="form-control" id="school_code" style="font-size:14px;color:#95949E;"
                                        required>
                                </div>
                                <div class="mb-3">
                                    <label for="school_code" class="form-label">School Contact
                                        <span class="text text-danger">*</span>
                                    </label>
                                    <input type="text" name="school_contact" placeholder="Enter School Code"
                                        class="form-control" id="school_contact" style="font-size:14px;color:#95949E;"
                                        required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="school_email" placeholder="Enter Email" class="form-control"
                                        id="school_email" style="font-size:14px;color:#95949E;" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="school_place" placeholder="Enter School Place"
                                        class="form-control" id="school_place" style="font-size:14px;color:#95949E;"
                                        required>
                                </div>
                            ...
                            <div class="col-lg-6 col-sm-12" style="font-family: Rubik; font-size:18px;color:#4E4D55;">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="concern_person_name" placeholder="Concern Person Name"
                                        class="form-control" id="concern_person_name" style="font-size:14px;color:#95949E;"
                                        required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="concern_person_phone" placeholder="+91" class="form-control"
                                        id="concern_person_phone" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="alt_contact_person_name"
                                        ...
                                        id="alt_contact_person_name" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="alt_contact_person_phone"
                                        ...
                                        id="alt_contact_person_phone" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
