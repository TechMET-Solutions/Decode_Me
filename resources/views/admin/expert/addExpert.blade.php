    ...
    <div class="app-wrapper" style="background: #FFFFF4;">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <x-session-message />
                <form action="{{ route('admin.storeexpert') }}" method="post" style="margin-left: 10px;"
                    enctype="multipart/form-data">
                    @csrf
                    <p style="font-family: Rubik; font-size:38px; font-weight:500px; color:#000">Expert Details</p>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" placeholder="+91" class="form-control"
                                        id="phone" pattern="[0-9]*" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" placeholder="Enter Email" class="form-control"
                                        id="email" style="font-size:14px;color:#95949E;" required>
                                </div>
                                {{-- <div class="mb-3">
                                    <label for="date_of_birth" class="form-label">Date of Birth
                                        <span class="text text-danger">*</span>
                                    </label>
                                    <input type="date" name="date_of_birth" placeholder="MM/DD/YYYY" class="form-control"
                                        id="date_of_birth" style="font-size:14px;color:#95949E;" required>
                                </div> --}}
                                <div class="mb-3">
                                    <label for="date_of_birth" class="form-label">Date of Birth
                                        <span class="text text-danger">*</span>
                                ...
                                <div class="mb-3">
                                    @php
                                        $qaulification = ['Bachlors', 'Masters', 'Doctorate'];
                                    @endphp
                                    ...
                                    <select class="form-control" name="qualification" required>
                                        ...
                                        @foreach ($qaulification as $single)
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="occupation" placeholder="Enter Occupation "
                                        class="form-control" id="occupation" style="font-size:14px;color:#95949E;" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-12" style="font-family: Rubik; font-size:18px;color:#4E4D55;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="expertise" placeholder="Enter Expertise"
                                        class="form-control" id="expertise" style="font-size:14px;color:#95949E;" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="department" placeholder="Enter department "
                                        class="form-control" id="department" style="font-size:14px;color:#95949E;"
                                        required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date_of_join"
                                        placeholder="Joining Date "class="form-control" id="date_of_join"
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="account_number" placeholder="Enter Bank Account Number"
                                        class="form-control" id="account_number" style="font-size:14px;color:#95949E;"
                                        required>
                                </div>
                                <div class="mb-3">
